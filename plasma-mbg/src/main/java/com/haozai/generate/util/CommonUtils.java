package com.haozai.generate.util;
...
import com.haozai.generate.Config;
...
public class CommonUtils {
    ...
    private static PackageConfig packageConfig2(String packageName) {
        return new PackageConfig()
                .setParent("../../resources/"+packageName)
                .setXml(Config.PACKAGE_NAME_XML)
                ;
    }
    ...
    public static void execute(DbType dbType, String dbUrl, String username, String password, String driver,
        ...
        PackageConfig packageConfig2 = packageConfig2(packageName);
